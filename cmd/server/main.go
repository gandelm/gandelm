...
import (
	...
	"github.com/gandelm/gandelm/internal/service/github_webhook"
	"github.com/rs/cors"
...
func Start(container container.Containerer) error {
	...
	mux.Handle(github_webhookv1connect.NewGitHubWebhookServiceHandler(github_webhook.NewGithubWebhookService(container)))
